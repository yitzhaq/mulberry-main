...
void CMessageWindow::OnUpdateMessageFlagsForwarded(CCmdUI* pCmdUI)
{
	OnUpdateMessageFlags(pCmdUI, NMessage::eForwarded);
}

void CMessageWindow::OnUpdateMessageFlagsMDNSent(CCmdUI* pCmdUI)
{
...
void CMessageWindow::OnMessageFlagsForwarded()
{
	OnMessageFlags(NMessage::eForwarded);
}

void CMessageWindow::OnMessageFlagsMDNSent()
{
