...
const char* cIMAP_CONTEXT_SEARCH =		"CONTEXT=SEARCH";
const char* cIMAP_CONTEXT_SORT =		"CONTEXT=SORT";
...
const char* cIMAP_CONDSTORE =		"CONDSTORE";
const char* cIMAP_QRESYNC =		"QRESYNC";
...
const char* cCANCELUPDATE				= "CANCELUPDATE";
...
const char* cBINARYSECTION_OUT =		"(BINARY[%s])";
const char* cBINARYSECTIONPEEK_OUT =	"(BINARY.PEEK[%s])";
const char* cBINARYSECTION_IN =			"BINARY[";
const char* cBINARYSIZE_IN =			"BINARY.SIZE[";
...
const char* cMODIFIED =					"MODIFIED";
const char* cVANISHED =					"VANISHED";
const char* cEARLIER =					"EARLIER";
const char* cCLOSED =					"CLOSED";
...
const char* cMBOXFLAGHASCHILDREN =		"\\HasChildren";
const char* cMBOXFLAGHASNOCHILDREN =	"\\HasNoChildren";
...
const char* cSEARCH_SAVEDBEFORE =		"SAVEDBEFORE";
