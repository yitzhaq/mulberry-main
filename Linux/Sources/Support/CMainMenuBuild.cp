...
const SMenuBuilder cFlagsMenuBuilder[] = 
{
	...
	{"Draft %b %h r %k Meta-Ctrl-5", CCommand::cFlagsDraft},
	{"Forwarded %b %h f %k Meta-Ctrl-6", CCommand::cFlagsForwarded},
	{"MDN Sent %b %h m %k Meta-Ctrl-7 %l", CCommand::cFlagsMDNSent},
...
const SMenuBuilder cFlagsMenuNoShortcutBuilder[] = 
{
	...
	{"Draft %b %h r", CCommand::cFlagsDraft},
	{"Forwarded %b %h f", CCommand::cFlagsForwarded},
	{"MDN Sent %b %h m %l", CCommand::cFlagsMDNSent},
	{"Label1 %b %h r", CCommand::cFlagsLabel1},
	{"Label2 %b %h r", CCommand::cFlagsLabel2},
	{"Label3 %b %h r", CCommand::cFlagsLabel3},
	{"Label4 %b %h r", CCommand::cFlagsLabel4},
