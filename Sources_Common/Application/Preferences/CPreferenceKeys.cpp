...
const char* cPrefsSection = "Preferences";
	...
	const char* cNetworkControlSection = "Network Control";						// This section new in v3.0b7
		...
		const char* cTCPKeepaliveEnabledKey = "TCP Keepalive Enabled";			// New as of v4_2a1
	...
	const char* cLetterSection = "Outgoing";
		...
		const char* cSubjectStripPrefixesKey = "Subject Strip Prefixes";	// New as of v4.2a1
	...
	const char* cAttachmentsSection = "Attachments";
		...
		const char* cMIMEMapKey = "Mappings";
			const char* cMIMEMapFileCreatorKey = "Creator";						// Also defined in COptionsMap.cpp
			const char* cMIMEMapFileTypeKey = "Type";							// Also defined in COptionsMap.cpp
			const char* cMIMEMapSuffixKey = "Suffix";							// Also defined in COptionsMap.cpp
			const char* cMIMEMapLaunchKey = "Launch Mode";						// Also defined in COptionsMap.cpp
